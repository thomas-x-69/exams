      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-10">
        ...
        <div className="lg:col-span-2">
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border border-white/10 p-6 h-full">
            ...
            <div className="mt-6 bg-white/5 rounded-xl p-4 border border-white/10 relative overflow-hidden">
              ...
              <div className="space-y-3 relative z-10">
                {plan.testimonials.map((testimonial, idx) => (
                  <div key={idx} className="flex items-start gap-2">
                    <div className="w-6 h-6 bg-gradient-to-br from-amber-500/30 to-yellow-500/30 rounded-full flex items-center justify-center text-white text-xs mt-0.5 flex-shrink-0 font-bold">
