...
const LandingHeader = ({ showSubjects, setShowSubjects }) => {
  ...
  // If not mounted yet (during SSR or hydration), render a minimal header
  if (!mounted) {
    return (
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3 px-2">
              <div className="w-12 h-12 rounded-2xl glass-effect flex items-center justify-center border border-white/10 overflow-hidden">
                {/* Empty div for spacing during hydration */}
              </div>
              <h1 className="text-lg font-bold text-white hidden sm:block">
                منصة الاختبارات المصرية
              </h1>
            </div>
            {/* Empty placeholder for auth controls */}
